...
int main() {
    ...
    if (std::abs(result.scattering[0](1,0)-rfmodel::Complex{0.5,0})>=1e-12) return 1;
    const auto parameters=rfmodel::extract_noise_parameters(result.scattering[0],result.noise_correlation[0]);
